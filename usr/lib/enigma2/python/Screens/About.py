...
config.CommitInfoSetup.commiturl = ConfigSelection(default='Enigma2', choices=[('Enigma2', _('Source-Enigma2')),
 ('XTA', _('Skin-XTA')),
 ('TechniHD', _('Skin-TechniHD')),
 ('Metrix', _('Skin-Metrix'))])
...
class About(Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['ColorActions', 'SetupActions', 'DirectionActions'], {'cancel': self.close,
         ...
         'down': self['AboutScrollLabel'].pageDown}, -2)
